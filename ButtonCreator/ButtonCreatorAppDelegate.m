...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *viewController1 = [[ButtonCreatorViewController alloc] initWithNibName:@"ButtonCreatorViewController" bundle:nil];
    UIViewController *viewController2 = [[TabBarCreatorViewController alloc] initWithNibName:@"TabBarCreatorViewController" bundle:nil];
